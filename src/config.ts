export interface PrismaTypeGeneratorOptions {
  ...
  /**
   * Generate basic utility types (Partial, Required, Readonly, DeepPartial, DeepRequired).
   * These types are always generated by default, but can be disabled if not needed.
   *
   * @default true
   */
...
export function parseConfig(
  ...
  return {
    ...
    splitBySchema,
    basicUtilityTypes: parseBoolean(config.basicUtilityTypes, true),
  };
}
